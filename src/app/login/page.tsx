        ...
        <div className="w-full max-w-md bg-white rounded-3xl shadow-2xl p-10 relative z-10 border border-orange-100">
            ...
            <form className="space-y-5" onSubmit={handleLogin}>
                {searchParams.get("registered") && (
                    <div className="p-4 bg-emerald-50 text-emerald-600 rounded-xl text-sm font-bold border border-emerald-100 animate-in fade-in slide-in-from-top-4 duration-500">
                ...
                <button
                    type="submit"
                    disabled={isLoading}
                    className="w-full bg-slate-900 text-white py-4 rounded-xl font-bold hover:bg-slate-800 transition-colors shadow-lg flex items-center justify-center gap-2"
                >
